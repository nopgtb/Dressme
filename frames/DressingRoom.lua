...
local modelX = { -- male = 2, female = 3
    min = {
        ...
        Pandaren =  {male = -0.75, female = -0.75},
    ...
    max = {
        ...
        Pandaren =  {male = 2.6, female = 1.55},
        Worgen =    {male = 3.2, female = 3.0},
        -- The Horde
...
local modelZ = {
    min = {
        ...
        Pandaren =  {male = -0.80, female = -0.60},
        Worgen =    {male = -1.15, female = -0.97},
        -- The Horde
    ...
    max = {
        ...
        Pandaren =  {male = 0.52, female = 0.75},
        Worgen =    {male = 1.15, female = 0.92},
        -- The Horde
